...
# Peter Norvig.
#
# David Noelle - Mon Oct  4 18:44:50 PDT 2021
#
...
class Node:
    ...
    def __init__(self, loc, parent=None, road=None, path_cost=0.0, h_eval=0.0):
    ...
    def expand(self, problem, h_fun=None):
        ...
        if self.depth >= depth_limit:
            ...
            return [self.child_node(problem, road, h_fun)
