...
# Denylson Fuentes helped me understand can replace x with Celine/Bob/etc.
# He also helped me reverse logic for the last sentence to replace the nots.
# I overhead the TA when she was helping Denylson about splitting the the sentences into multiple predicates
# That helped a lot
# PLACE YOUR NAME AND THE DATE HERE
# Jim Nguyen 10/27/2021
...
# following knowledge.
#
# Celene is a vampire. check
# Mario is a werewolf. check
# Mildred is a witch. check
# Bob, Lin, and Maurice are people. check
# A person who is dead is a victim. check
...
# A implies B
# how to show this in definite clauses
# not A V not B (V = or)

# not A implies not B

# not alpha1 V not alpha2 V ... V not alpha n V beta
# how to show
# not(alpha1 ^ alpha2 ^...^ alpha_n) V B
# alpha1 ^ alpha2 ^ ... ^ alpha_n => B
# use variables start lowercase
# for constants/names start Capitalletters
# try to avoid ors
...
#unify(knows(John, x), knows(y, Bob))
# {(x/Bob),(y/John)}
